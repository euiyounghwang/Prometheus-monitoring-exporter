...
class DataServiceServicer(object):
    ...
    def GetStreamData(self, request, context):
        """1. Server-side streaming: 요청 1개 -> 응답 여러 개
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')

    def UploadStreamData(self, request_iterator, context):
        """2. Client-side streaming: 요청 여러 개 -> 응답 1개
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
    ...
    def Chat(self, request_iterator, context):
        """3. Bidirectional streaming: 요청 여러 개 -> 응답 여러 개
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_DataServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'UploadStreamData': grpc.stream_unary_rpc_method_handler(
                    servicer.UploadStreamData,
                    request_deserializer=service__pb2.Request.FromString,
                    response_serializer=service__pb2.Response.SerializeToString,
            ),
...
class DataService(object):
    ...
    @staticmethod
    def UploadStreamData(request_iterator,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
