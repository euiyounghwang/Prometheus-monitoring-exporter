...
/* get commands */
func get_sudo_commands(cmd_input string) string {

	// fmt.Println(cmd_input)
	...
	cmd := exec.Command("/bin/sh", "-c", cmd_input) // Example: listing contents of /root
...
func get_process(process_name string, cmd string) {
	SERVICE_ALIVE = false
